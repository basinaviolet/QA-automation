...
public class BoardPage {
  ...
  //  private final SelenideElement listWrapper = $(By.className("js-list list-wrapper"));
    ...
    public boolean ifBoardPage(String forCheck) {
        try {
            //   System.out.println("text: " + mainPageCheckH3.getText() + ", value: " + mainPageCheckH3.getValue() + ", OwnText: " + mainPageCheckH3.getOwnText());
            //       boardPageCheckH1 = $(By.xpath(boardPageCheckH1Locator + forCheck + "]"));
            boardPageName.hover();
    ...
    public boolean ifTemplateBoardPage(String forCheck) {
        try {
            boardPageName.hover();
            System.out.println("return: " + (boardPageName.getText().indexOf(forCheck) == 0));
    ...
    public CloseBoardPage closeBoardPage() {
        ...
        menuForOtherOptionsContainer.hover();
        menuForOtherOptionsContainerOpenMore.click();
        menuForOtherOptionsContainerCloseBoard.click();
        menuForOtherOptionsContainerSubmitCloseBoard.click();
        return page(CloseBoardPage.class);
    }
